...
class HomeSplash extends React.Component {
  render() {
    ...
    const SplashContainer = props => (
      <div className="homeContainer announcement">
  ...
  render() {
    ...
    const FeatureCallout = () => (
      <div
        ...
        <h2>Check out CODE OF CONDUCT in our<a href="https://github.com/broadinstitute/dsp-appsec-infrastructure-apps"> Github repository</a></h2>
        <MarkdownBlock> Contributions are welcomed. </MarkdownBlock>
      </div>
    );
    ...
    const Features = () => (
      <Block layout="fourColumn">
        {[
          {
            content: 'AppSec Tools deployed in a managed Kubernetes Cluster',
            image: `${baseUrl}img/kubernetes-logo.svg`,
            imageAlign: 'top',
